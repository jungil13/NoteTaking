  ...
  <div class="py-20 my-14">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
      <div class="hidden lg:block lg:w-1/2 bg-cover"
        style="background-image:url('https://plus.unsplash.com/premium_photo-1674675647033-454dc0df1e92?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
      </div>
      <form @submit.prevent="login" class="w-full p-8 lg:w-1/2">
        <div class="flex items-center justify-center h-12 rounded-full">
          <img src="/logsa.png" class="h-full bg-black rounded-full" alt="Flowbite Logo">
        </div>
